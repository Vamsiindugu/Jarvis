...
> *"Jarvis, make a hex bolt with a 5mm thread."* — **Done.**
...
```bash
# 1. Clone and enter
git clone https://github.com/vamsiindugu/jarvis_v2.git && cd jarvis_v2
...
- The `projects/` folder contains user data; do not commit it to Git.
